...
from net.loss_functions import Homo_Total_Loss
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_model_name', type=str, default='./dunhuang_checkpoint/homo_model/homo_model')
    parser.add_argument('--resume', type=bool, default=False)
    parser.add_argument('--resume_epoch', type=int, default=91)
    ############# 2. homo + homo + mesh #################
    ...
    dataloders['test'] = DataLoader(image_datasets['test'], batch_size=args.test_batch_size, shuffle=False, num_workers=2)
    # define somethings
    criterion = Homo_Total_Loss(l_num=1).to(args.device_ids_alls[0])
