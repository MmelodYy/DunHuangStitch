...
def save_to_file_wolabel(index, image1, image2, path_dest, gt_4pt_shift):
    if not os.path.exists(path_dest):
        os.makedirs(path_dest)
    input1_path = path_dest + '//input1'
    input2_path = path_dest + '//input2'
...
def generate_dataset(path_source, path_dest, rho, height, width, data, box, overlap):
    for count in range(0, data):
        ...
        save_to_file_wolabel(str(count + 1).zfill(6), image1, image2, path_dest, gt_4pt_shift)
        print(count + 1)



raw_image_path_train = './DunHuangDataSets//AllData'
raw_image_path_test = './DunHuangDataSets//AllData'
# raw_image_path_test = './DunHuangDataSets//test'
...
dataset_size = 8051
generate_image_path = './DHSD128/training'
generate_dataset(raw_image_path_train, generate_image_path, rho, height, width, dataset_size, box_size, overlap_rate)
### generate testing dataset
print("Testing dataset...")
dataset_size = 1714
generate_image_path = './DHSD128/testing'
generate_dataset(raw_image_path_test, generate_image_path, rho, height, width, dataset_size, box_size, overlap_rate)
